...
The first line contains two integers n and p (1≤n≤105; 1≤p≤10^5) — the number of residents and the cost for Pak Chanek to share the announcement directly to one resident.
