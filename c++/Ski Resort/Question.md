...
The first line of each test case contains three integers n, k, q (1≤n≤2⋅10^5, 1≤k≤n, −109≤q≤10^9) — the length of the array a, the minimum number of days at the resort, and the maximum comfortable temperature for Dima.

The second line of each test case contains n integers a1,a2,a3,…,an (−109≤ai≤10^9) — the temperature at the ski resort.
