...
The first line of each case contains an integer n (1≤n≤2⋅10^5) — the number of buildings that "Divan's Sofas" is going to build, apart from the headquarters.

The second line contains the sequence a1,a2,…,an (0≤ai≤10^6), where ai is the number of visits to the i-th building.
...
On the second line print the sequence x0,x1,…,xn of n+1 integers, where xi (−10^6≤xi≤10^6) is the selected coordinate of the i-th building. It can be shown that an optimal answer exists with coordinates not exceeding 106.
